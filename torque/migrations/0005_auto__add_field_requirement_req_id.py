...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requirement.req_id'
        db.add_column(u'torque_requirement', 'req_id',
                      self.gf('django.db.models.fields.CharField')(default='R-FEP-DATA-001', unique=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requirement.req_id'
        db.delete_column(u'torque_requirement', 'req_id')
    ...
    models = {
        ...
        u'torque.requirement': {
            ...
            'req_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
