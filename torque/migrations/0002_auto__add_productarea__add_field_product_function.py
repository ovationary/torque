...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'torque_productarea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['torque.Product'])),
        ))
        db.send_create_signal(u'torque', ['ProductArea'])

        # Adding field 'Product.function'
        db.add_column(u'torque_product', 'function',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'torque_productarea')

        # Deleting field 'Product.function'
        db.delete_column(u'torque_product', 'function')
